...
(function (factory) {
  ...
  var Editor = function (handler) {
    ...
    this.imageShape = function ($editable, value, $target) {
      ...
      $target.removeClass('images-rounded images-circle images-thumbnail');
  ...
  var Button = function () {
    ...
    this.update = function ($container, styleInfo) {
      ...
      if (styleInfo.image) {
        ...
        btnState('button[data-event="imageShape"][data-value="images-rounded"]', function () {
          return $img.hasClass('images-rounded');
        });
        btnState('button[data-event="imageShape"][data-value="images-circle"]', function () {
          return $img.hasClass('images-circle');
        });
        btnState('button[data-event="imageShape"][data-value="images-thumbnail"]', function () {
          return $img.hasClass('images-thumbnail');
        });
        btnState('button[data-event="imageShape"]:not([data-value])', function () {
          return !$img.is('.images-rounded, .images-circle, .images-thumbnail');
        });
