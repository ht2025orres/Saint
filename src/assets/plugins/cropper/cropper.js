...
var preview$1 = {
  initPreview: function initPreview() {
    ...
    self.$clone2 = $clone2 = $('<images ' + crossOrigin + ' src="' + url + '">');
    ...
    self.$preview.each(function (i, element) {
       ...
       */
      $this.html('<images ' + crossOrigin + ' src="' + url + '" style="' + 'display:block;width:100%;height:auto;' + 'min-width:0!important;min-height:0!important;' + 'max-width:none!important;max-height:none!important;' + 'image-orientation:0deg!important;">');
    });
  },
...
var Cropper = function () {
  ...
  createClass(Cropper, [{
    ...
    value: function clone() {
      ...
      var $clone = $('<images ' + getCrossOrigin(crossOrigin) + ' src="' + (crossOriginUrl || url) + '">');
